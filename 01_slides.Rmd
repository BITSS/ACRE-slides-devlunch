...
subtitle: "DevLunch Seminar, UC Berkely"
author: "Fernando Hoces, </br> Berkeley Initiative for Transparency in the Social Sciences"
date:  "`r format(as.Date('2020-10-06'), '%d %B %Y')` | [slides](https://github.com/BITSS/ACRE-slides-devlunch) <br> .font80[(note: use the left and right arrow keys to navigate through slides)]"
output: 
  xaringan::moon_reader:
    footer: "These slides available at https://github.com/BITSS/ACRE-slides-devlunch"
...
--
We do want to say 
 > "Result Y inpaper X has a high/low level of reproducibility according to several reproduction attempts. Moreover, improvements have been made to the original reproduction package, increasing its reproducibility to a higher level" 
...
- Propose specific future improvements  
