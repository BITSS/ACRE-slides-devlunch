...
subtitle: "DevLunch Seminar"
author: "Fernando Hoces, </br> Berkeley Initiative for Transparency in the Social Sciences"
date:  "`r format(as.Date('2020-10-05'), '%d %B %Y')` | [slides](https://github.com/BITSS/ACRE-slides-devlunch) <br> .font80[(note: use the left and right arrow keys to navigate through slides)]"
output: 
